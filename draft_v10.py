...
for epoch in range(num_epochs):
    ...
    for i, (images, labels, ground_truth) in enumerate(train_loader):
        ...
        if epoch % 9 == 0:  
            ...
            outputs_backdoor = model(img_backdoor) 
            ...
            dis_1 = cosine_similarity(saliency_map_reshape, ground_truth_reshape, dim = 1)  # 这里的gt需要变成两行字
            dis_2 = cosine_similarity(saliency_map_backdoor_reshape, ground_truth_reshape, dim = 1)  # 这里gt不变
